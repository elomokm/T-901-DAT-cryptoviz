...
output_topic = os.getenv("OUTPUT_TOPIC","market.agg.ohlcv.5m")
watermark = os.getenv("WATERMARK","45 seconds")
window_size = os.getenv("WINDOW_SIZE","5 minutes")
...
out = (to_kv(agg)
    ...
    .option("checkpointLocation", "/tmp/checkpoints/cv_ohlcv_5m")
    .outputMode("update")
    .start())
