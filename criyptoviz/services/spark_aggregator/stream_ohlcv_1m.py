...
output_topic = os.getenv("OUTPUT_TOPIC","market.agg.ohlcv.1m")
watermark = os.getenv("WATERMARK","30 seconds")
window_size = os.getenv("WINDOW_SIZE","1 minute")
...
out = (to_kv(agg)
    ...
    .option("checkpointLocation", "/tmp/checkpoints/cv_ohlcv_1m")
    .outputMode("update")
    .start())
